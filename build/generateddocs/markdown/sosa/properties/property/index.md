...
# SOSA Property (Schema)

`ogc.sosa.properties.property` *v1.0*

An identifiable quality (property, characteristic) of a FeatureOfInterest. A Property can be associated with different Features of Interest, may be observed by a Procedure, and can be acted upon by an Actuator. ObservableProperty, ActuatableProperty, and SampledProperty are all types of Property.
...
* YAML version: [schema.yaml](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/property/schema.json)
* JSON version: [schema.json](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/property/schema.yaml)
...
[context.jsonld](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/property/context.jsonld)
...
* Path: `_sources/properties/property`
