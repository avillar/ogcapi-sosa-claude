...
System is a unit of abstraction for pieces of infrastructure that implement Procedures. A System may have components (implemented as subsystems), and may be deployed at a Platform. Sensor, Actuator and Sampler are all types of System.
...
```json
{
  ...
  "id": "eg:systems/weather-station-1",
  "name": "Weather Station Alpha",
  "implements": [
    "eg:procedures/thermometer-reading",
    "eg:procedures/barometer-reading"
  ],
  "hasSubSystem": [
    {
...
<http://example.org/sensors/barometer-1> sosa:sensorKind eg:BarometerSensor .

<http://example.org/sensors/thermometer-1> sosa:sensorKind eg:ThermometerSensor .
...
* YAML version: [schema.yaml](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/system/schema.json)
* JSON version: [schema.json](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/system/schema.yaml)
...
[context.jsonld](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/system/context.jsonld)
