...
# SOSA Execution (Schema)

`ogc.sosa.properties.execution` *v1.0*

An act of carrying out a Procedure by a System on or about a FeatureOfInterest, with the objective of producing a Result. Execution is the common abstract class for Observation, Actuation and Sampling.
...
* YAML version: [schema.yaml](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/execution/schema.json)
* JSON version: [schema.json](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/execution/schema.yaml)
...
[context.jsonld](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/execution/context.jsonld)
