...
# SOSA FeatureOfInterest (Schema)

`ogc.sosa.properties.featureOfInterest` *v1.0*

The thing whose property is being observed or acted upon. A feature of interest is an abstraction of a real-world phenomenon to which a property being observed, or acted on by an actuator, or sampled, belongs.
...
{
  "@context": {
    "eg": "http://example.org/features/"
  },
  "id": "eg:river-thames",
  "hasProperty": [
    "http://example.org/properties/waterTemperature",
    "http://example.org/properties/waterLevel"
  ]
}
...
#### ttl
```ttl
@prefix eg: <http://example.org/features/> .
@prefix sosa: <http://www.w3.org/ns/sosa/> .

eg:river-thames sosa:hasProperty <http://example.org/properties/waterLevel>,
        <http://example.org/properties/waterTemperature> .
...
* YAML version: [schema.yaml](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/featureOfInterest/schema.json)
* JSON version: [schema.json](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/featureOfInterest/schema.yaml)
...
[context.jsonld](https://avillar.github.io/ogcapi-sosa-claude/build/annotated/sosa/properties/featureOfInterest/context.jsonld)
...
* Path: `_sources/properties/featureOfInterest`
